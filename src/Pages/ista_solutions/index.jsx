          ...
          <div className="ista">
            <div className="ista_left">
              ...
              <p className="ista_text">
                "Discover Perfection: Our Ideal IT Service, Just for You!
                Embrace Innovation and Efficiency with Us. Unlock Limitless
                Possibilities, Right Here, Right Now! Experience Excellence in
                Software Solutions. Your IT Dreams Come True with Our Expert
                Team. Don't Wait, Act Now!"
              </p>
            </div>
